// Logging middleware for vox clients.
//
...
export interface LoggingOptions {
  /**
   * Namespace for debug matching. Defaults to "vox:rpc".
   * Logging is enabled when localStorage.debug matches this namespace.
   * Supports patterns like "vox:*" or "*".
   */
  namespace?: string;
 ...
 * ```javascript
 * localStorage.debug = 'vox:*'  // Enable all vox logging
 * localStorage.debug = 'vox:rpc'  // Enable only RPC logging
