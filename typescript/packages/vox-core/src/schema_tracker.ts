...
import { buildPlan, resolveTypeRef } from "@bearcove/binette";
...
export interface MethodSendSchemas {
  ...
  argsRootRef: import("@bearcove/binette").TypeRef;
  /** Root TypeRef for the response schema. */
  responseRootRef: import("@bearcove/binette").TypeRef;
}
...
export interface ServiceSendSchemas {
  ...
  schemas: Map<bigint, import("@bearcove/binette").Schema>;
...
export class SchemaSendTracker {
  ...
  prepareSchemas(
    ...
    const schemas = newDeps
      ...
      .filter((s): s is import("@bearcove/binette").Schema => s !== undefined);
