 ...
 * transport mechanisms for sending and receiving vox messages.
 *
 * Implementations:
 * - LengthPrefixedFramed (vox-tcp) for byte streams (TCP)
 * - WsTransport (vox-ws) for WebSocket
 */

/**
 * Interface for transports that can send and receive vox messages.
 *
...
export interface MessageTransport {
  /**
   * Send a message (raw binette-encoded payload for WebSocket,
