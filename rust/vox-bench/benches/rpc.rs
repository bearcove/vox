...
mod codec {
    ...
    mod args {
        ...
        fn jit_decode(bencher: Bencher, n: usize) {
            let fixture = CodecFixture::<GnarlyArgs>::new((make_gnarly_payload(n, 0),));
            let decode_fn = vox_bench::prepare_jit_decoder_owned_fn::<GnarlyArgs>(
                &fixture.plan,
                &fixture.registry,
            );
            bencher.bench_local(|| {
        ...
        fn jit_decode_borrowed(bencher: Bencher, n: usize) {
            ...
            let registry = vox_types::SchemaRegistry::new();
            let decode_fn = vox_bench::prepare_jit_decoder_borrowed_fn::<BorrowedArgs<'static>>(
                &plan, &registry,
            );
            bencher.bench_local(|| {
    ...
    mod response {
        ...
        fn jit_decode(bencher: Bencher, n: usize) {
            let fixture = CodecFixture::<GnarlyResponse>::new(Ok(make_gnarly_payload(n, 0)));
            let decode_fn = vox_bench::prepare_jit_decoder_owned_fn::<GnarlyResponse>(
                &fixture.plan,
                &fixture.registry,
            );
            bencher.bench_local(|| {
    ...
    mod wide_struct {
        ...
        fn jit_decode(bencher: Bencher) {
            ...
            let decode_fn = vox_bench::prepare_jit_decoder_owned_fn::<WideStruct>(
                &fixture.plan,
                &fixture.registry,
            );
            bencher.bench_local(|| {
    ...
    mod many_variants {
        ...
        fn jit_decode(bencher: Bencher, variant: u32) {
            ...
            let decode_fn = vox_bench::prepare_jit_decoder_owned_fn::<ManyVariants>(
                &fixture.plan,
                &fixture.registry,
            );
            bencher.bench_local(|| {
    ...
    mod tree {
        ...
        fn jit_decode(bencher: Bencher, depth: u32) {
            ...
            let decode_fn =
                vox_bench::prepare_jit_decoder_owned_fn::<Tree>(&fixture.plan, &fixture.registry);
            bencher.bench_local(|| {
    ...
    mod numeric_buffer {
        ...
        fn jit_decode(bencher: Bencher, n: usize) {
            ...
            let decode_fn = vox_bench::prepare_jit_decoder_owned_fn::<NumericBuffer>(
                &fixture.plan,
                &fixture.registry,
            );
            bencher.bench_local(|| {
