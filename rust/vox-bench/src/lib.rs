...
pub mod shapes {
    ...
    pub fn make_wide(seq: u32) -> WideStruct {
        let s = seq as i64;
        WideStruct {
            a00: seq.wrapping_mul(1),
            a01: seq.wrapping_mul(3),
            a02: seq.wrapping_mul(7),
            a03: seq.wrapping_mul(11),
            a04: seq.wrapping_mul(13),
            a05: seq.wrapping_mul(17),
            a06: seq.wrapping_mul(19),
            a07: seq.wrapping_mul(23),
            a08: seq.wrapping_mul(29),
            a09: seq.wrapping_mul(31),
            a10: seq.wrapping_mul(37),
            a11: seq.wrapping_mul(41),
            a12: seq.wrapping_mul(43),
            a13: seq.wrapping_mul(47),
            a14: seq.wrapping_mul(53),
            a15: seq.wrapping_mul(59),
            b00: s,
            b01: -s,
            b02: s.wrapping_mul(2),
            b03: -s.wrapping_mul(3),
            b04: s.wrapping_mul(5),
            b05: -s.wrapping_mul(7),
            b06: s.wrapping_mul(11),
            b07: -s.wrapping_mul(13),
            b08: s.wrapping_mul(17),
            b09: -s.wrapping_mul(19),
            b10: s.wrapping_mul(23),
            b11: -s.wrapping_mul(29),
            b12: s.wrapping_mul(31),
            b13: -s.wrapping_mul(37),
            b14: s.wrapping_mul(41),
            b15: -s.wrapping_mul(43),
            c00: seq & 1 == 0,
            c01: seq & 2 != 0,
            c02: seq & 4 != 0,
            c03: seq & 8 != 0,
    ...
    pub fn make_numeric_buffer(n: usize, seq: u32) -> NumericBuffer {
        ...
        let mono_f64 = (0..n)
            ...
            .collect();
        let flags = (0..n)
            .map(|i| (seq.wrapping_add(i as u32)) & 1 == 0)
            .collect();
        NumericBuffer {
            sample_rate: 48_000,
            channels: 2,
